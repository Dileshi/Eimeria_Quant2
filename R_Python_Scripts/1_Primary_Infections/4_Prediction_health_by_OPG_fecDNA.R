...
source("R_Python_Scripts/2_qPCR_Data_Prep.R")

###Get Panel A, B and C from script 3
if(!exists(c("A","B","C"))){
  source("R_Python_Scripts/3_Data_analysis_qPCR_flotation.R")
}
...
ggsave(file = "Figures/Figure_3.pdf", tmp.fig, width = 13.5, height = 10.5, dpi = 600)
